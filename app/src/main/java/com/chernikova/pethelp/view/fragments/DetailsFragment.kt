...
import com.chernikova.pethelp.databinding.FragmentDetailsBinding
import com.chernikova.pethelp.notification.NotificationHelper
import com.chernikova.pethelp.view_model.DetailsFragmentViewModel
import com.chernikova.remote_module.entity.ApiConstants
import com.google.android.material.snackbar.Snackbar
import kotlinx.coroutines.*

class DetailsFragment : Fragment() {
    private lateinit var animalCard: AnimalCard
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.detailsFabFavorites.setOnClickListener {
            if (!animalCard.isInFavorites) {
                binding.detailsFabFavorites.setImageResource(R.drawable.favorite)
                animalCard.isInFavorites = true
            } else {
                binding.detailsFabFavorites.setImageResource(R.drawable.favorite_border)
                animalCard.isInFavorites = false
            }
        }
        ...
        binding.detailsFabShare.setOnClickListener {
            ...
            intent.putExtra(
                Intent.EXTRA_TEXT,
                "Check out this film: ${animalCard.title} \n\n ${animalCard.description}"
            )
        ...
        binding.detailsFabWatchLater.setOnClickListener {
            NotificationHelper.notificationSet(requireContext(), animalCard)
        }
    }
    ...
    private fun setFilmsDetails() {
        ...
        animalCard = arguments?.get("animalCard") as AnimalCard

        //Устанавливаем заголовок
        binding.detailsToolbar.title = animalCard.title
        ...
        binding.detailsDescription.text = animalCard.description

        binding.detailsFabFavorites.setImageResource(
            if (animalCard.isInFavorites) R.drawable.favorite
    ...
    private fun performAsyncLoadOfPoster() {
        ...
        MainScope().launch {
            ...
            val job = scope.async {
                viewModel.loadWallpaper(animalCard.poster.toString())
            }
    ...
    private fun saveToGallery(bitmap: Bitmap) {
        ...
        val contentValues = ContentValues()?.apply {
            ...
            put(MediaStore.Images.Media.TITLE, animalCard.title?.handleSingleQuote())
            put(
                MediaStore.Images.Media.DISPLAY_NAME,
                animalCard.title?.handleSingleQuote()
            )
